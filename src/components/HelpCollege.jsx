...
export function HelpCollege() {
  const navigate = useNavigate();

  const collegeInfo = [
    { label: 'Почта', value: 'college@rguk.ru' },
    { label: 'Телефон', value: '8 (495) 811-01-01 доб. 1381' },
    { label: 'Адрес', value: 'Имущественный комплекс "Малая Калужская", Учебный корпус №2, Малый Калужский пер., д. 2, стр. 1' },
    { label: 'Кабинет', value: '2417а' },
    { label: 'Режим работы', value: 'пн-пт с 9:00 - 18:00' }
  ];
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img 
                ...
                alt="Пономарева Марина Александровна"
                style={{
                  width: '105px',
                  height: '125px',
                  borderRadius: '20%',
