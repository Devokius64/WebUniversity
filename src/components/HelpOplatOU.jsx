...
export function HelpOplatOU() {
  const navigate = useNavigate();

  const departmentInfo = [
    { label: 'Почта', value: 'opou@rguk.ru' },
    { label: 'Телефон', value: '8 (495) 811-01-01 доб. 1222' },
    { label: 'Адрес', value: 'Имущественный комплекс "Малая Калужская", Учебный корпус №1, Малая Калужская улица, д. 1, каб.1209' },
    { label: 'Режим работы', value: 'пн - чт с 10.00 до 17.00, пт - с 10.00 до 13.00. Обед: с 13:00 до 14:00' }
  ];

  const employees = [
    {
      title: 'Отдел платных образовательных услуг',
      name: 'Байчук Елена Александровна',
      img: '/images/заглушка.jpg'
    },
    {
      title: 'Делопроизводитель',
      name: 'Михайлова Мария Евгеньевна',
      img: '/images/заглушка.jpg'
    },
    {
      title: 'Делопроизводитель',
      name: 'Белякова Юлия Алексеевна',
      img: '/images/заглушка.jpg'
    }
  ];
